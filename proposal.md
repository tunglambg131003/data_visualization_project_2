...
|:-----|:------|:--------|:-------------------------|
| **Week 1 (25/4 - 4/5)** | Repository Initialization and Data Preprocessing | - Set up public GitHub repository<br>- Acquire datasets and conduct initial data cleaning<br>- Perform exploratory data analysis (EDA) to identify data limitations and trends<br>- Process spatial data for NYC borough mapping | Nguyen Tung Lam |
